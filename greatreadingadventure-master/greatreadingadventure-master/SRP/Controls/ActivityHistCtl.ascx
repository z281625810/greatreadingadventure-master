...
<div class="row margin-1em-top hidden-print margin-halfem-top">
    ...
    <div class="col-xs-12 col-sm-5 col-md-4">
        <div class="pull-right margin-halfem-bottom">
            ...
            <asp:HyperLink runat="server" NavigateUrl="~/Account/BookList.aspx" CssClass="btn btn-default"><span class="glyphicon glyphicon-bookmark margin-halfem-right"></span>Book Read</asp:HyperLink>
            <asp:HyperLink runat="server" NavigateUrl="~/Account/HealthList.aspx" CssClass="btn btn-default"><span class="glyphicon glyphicon-bookmark margin-halfem-right"></span>Health Choices</asp:HyperLink>
            <div class="btn-group">
        ...
        <asp:Panel ID="activitiesPanel" runat="server" Visible="true">
            <table class="table table-compact table-hover">
                <thead>
                    <tr>
                        <th>Days</th>
                        <th>Read for at least 15 mins</th>
                        <th>Date</th>
                    </tr>
                </thead>
                <tbody>
